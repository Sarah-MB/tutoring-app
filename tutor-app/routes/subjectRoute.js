...
app.route('/category/:category_id/subjects')
   .get(subjectController.subject_category_list);
//get one subjects by id
app.route('/category/subject/:subject_category_id')
      .get(subjectController.subject_category_id);
